...
const zhTW: Record<string, string> = {
  ...
  "Open Engineering Readiness": "開啟工程準備度",
  "Open Source": "開啟來源",
  ...
  "Engineering readiness improved. Ready to evaluate engineering phase.": "工程準備度已提升，可以評估工程階段。",
  ...
  "Review engineering readiness as the next phase.": "下一階段請檢查工程準備度。",
  "Resolve": "解決",
  "Save Decision": "儲存決策",
